...
export class Migration20250201051102 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table if not exists "student_profile" ("id" text not null, "portal_id" integer not null, "student_enrollment_code" integer not null, "father_name" text null, "mother_name" text null, "mother_phone" text null, "mother_email" text null, "gender" text check ("gender" in (\'Male\', \'Female\', \'Other\')) null, "hap" integer null, "hasdp" integer null, "first_term_paid" boolean not null default false, "house" text null, "ai" boolean null, "academic_year" integer null, "date_of_admission" timestamptz null, "application_no" integer null, "locality" text null, "otp" text null, "active" boolean null, "referral_code" text null, "is_sheffler" boolean null, "student_references_code" text null, "student_id" text not null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "student_profile_pkey" primary key ("id"));');
